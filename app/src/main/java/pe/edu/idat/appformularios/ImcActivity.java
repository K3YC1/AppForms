...
public class ImcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        Double talla = Double.parseDouble(binding.txtpeso.getText().toString());
        Double peso = Double.parseDouble(binding.txttalla.getText().toString());
